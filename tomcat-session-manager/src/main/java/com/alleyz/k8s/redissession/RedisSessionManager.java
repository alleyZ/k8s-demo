package com.alleyz.k8s.redissession;
...
public class RedisSessionManager extends ManagerBase implements Lifecycle {
  ...
  protected String serializationStrategyClass = "com.alleyz.k8s.redissession.JavaSerializer";

  protected EnumSet<SessionPersistPolicy> sessionPersistPoliciesSet = EnumSet.of(SessionPersistPolicy.DEFAULT);

  // com.alleyz.k8s.redissession.SessionSerializationMetadata
  // com.alleyz.k8s.redissession.SessionSerializationMetadata
  /**
    ...
    try {
      ...
      if (null != session) {
        try {
          ...
          log.error("Error saving newly created session: " + ex.getMessage(), ex);
          ex.printStackTrace();
